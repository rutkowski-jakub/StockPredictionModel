...
The features used for the predicition were a mix of exponetially smoothed OHLC data points and techinical indicators, following work from (Khaidem et al., 2016).
